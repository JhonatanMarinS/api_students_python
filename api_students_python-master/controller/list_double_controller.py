...
list_se_service = ListDoubleService()

@app_list_double.route('/list_se_doble/all')
def get_all_students():
    return Response(status=200,
                    response=json.dumps(list_se_service.get_all_students()
                    ,cls=UtilEncoder),mimetype="application/json")

@app_list_double.route('/list_se_doble/add_to_start',methods=['POST'])
...
@app_list_double.route('/list_se/add', methods=['POST'])
...
@app_list_double.route('/list_se/add_to_position', methods=['POST'])
...
@app_list_double.route('/list_se/delete_to_position',methods=['POST'])
