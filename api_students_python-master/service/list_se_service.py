...
class ListSEService:
    ...
    def __init__(self):
        ...
        #carloaiza = Student({"idenfication":"75147236","name":"Carlos Loaiza","gender":1,"salary":2000000,"job":True,"city":self.cities[2]})
        #self.students.add(carloaiza)

        #self.students.add(Student({"idenfication": "1060456789","name": "Valentina Hurtado","gender":2, "salary":0,"job":False,"city":self.cities[0]}))
